...
if not fs.exists("/BCWorks_MiniOS") then
    ...
    if hBootLoader ~= nil then
        local bootLoaderContent = http and http.get("https://raw.githubusercontent.com/BlackCultistHub/BCWorks_MiniOS/develop/core/bootLoader.lua")
...
local packageListContent = http and http.get("https://raw.githubusercontent.com/BlackCultistHub/BCWorks_MiniOS/develop/core/packageList")
...
for name, path in pairs(packageList.modulesCoreList) do
    ...
    local moduleCoreContent = http.get("https://raw.githubusercontent.com/BlackCultistHub/BCWorks_MiniOS/develop/core/" .. name)
...
for name, path in pairs(packageList.modulesList) do
    ...
    local moduleContent = http.get("https://raw.githubusercontent.com/BlackCultistHub/BCWorks_MiniOS/develop/modules/" .. name)
